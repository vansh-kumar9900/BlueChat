  ...
  return (
    <div className="min-h-screen grid place-items-center bg-slate-50 dark:bg-slate-950 p-4">
      ...
      >
        ...
        <div className="text-sm text-slate-500 dark:text-slate-400 mt-1">Create your account to get started.</div>
        ...
        <div className="mt-4 text-sm text-slate-600 dark:text-slate-300">
          ...
          <Link className="text-brand-600 dark:text-brand-400 font-medium hover:underline" to="/login">
            Login
          </Link>
        </div>
      </form>
